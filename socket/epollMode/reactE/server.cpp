...
{
    if(!log4cplusInitialize()){
        printf("initialize log4cplus fail!\n"); 
    }

    unsigned short port = SERV_PORT;
    LOG_WRAN("test this function"); 
    if(argc == 2){
        port = atoi(argv[1]);
    }
...
{
    const char *lv_configFileName = "log4cplus.epoll.react.properties";
    return PlusLogger::instance().initLog4cplus(lv_configFileName);
}
